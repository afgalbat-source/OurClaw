...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.fs.readOnlyRoots":
    "Additional absolute directory roots that read can access when tools.fs.workspaceOnly=true; write/edit/apply_patch remain workspace-only.",
